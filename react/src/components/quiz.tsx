...
const elementsForDelete: Array<
    keyof Pick<QuizType, "o_img1" | "o_img2" | "o_img3" | "o_img4">
> = ["o_img1", "o_img2", "o_img3", "o_img4"];
...
const Quiz = ({
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        imageNameArr[Object.keys(imageArr).indexOf(e.target.name)] = e.target
            .files
        ...
        switch (value) {
            case 0:
                return (
                    <>
                        ...
                        />
                        <T>
                            Введите код регионa. Если Вы не занете код Вашего
                            региона нажмите:
                        </T>
                        <ScrollDialog>
                            <CardMedia
            ...
            case 2:
                return (
                    <>
                        <T>
                            В год какого животного вы родились? Если вы не
                            знаете в год какого животного вы родились, то дата
                            начала и конец вашего года указаны :
                        </T>
                        <ScrollDialog>
                            <CardMedia
                                component="img"
            ...
            case 3:
                return (
                    <>
                        <T>
                            Кто вы по знаку зодиака? Если не знаете свой знак
                            зодиака, то посмотрите подсказку:
                        </T>
                        <ScrollDialog>
                            <CardMedia
                                component="img"
            ...
            case 4:
                return (
                    <>
                        <T>
                            Выберете пожалуйста 2-а своих психологических языка
                            любви. Это то, как вы понимаете, что вас любят, и вы
                            готовы так же выражать свою любовь. Языки любви
                            посмотреть:
                        </T>
                        <ScrollDialog>
                            <CardMedia
            ...
            case 7:
                return (
                    <>
                        ...
                        <T>
                            Кликни что бы подставить :{" "}
                            <a
                                onClick={(e) => {
                                    setValue(
                                        "vk",
                                        "https://vk.com/goroskoper2000"
                                    );
                                }}
                            >
                                https://vk.com/goroskoper2000
            ...
            case 8:
                return (
                    <>
                        <T>
                            Чем я Вам могу помочь? Что бы Вы хотели? Кого бы Вы
                            хотели найти? Просьба дать максимально развернутый
                            ответ.
                        </T>
                        <FormInputTextAria
                            control={control}
            ...
            case 10:
                return (
                    <>
                        <T>
                            Расскажите, пожалуйста, о себе для презентации вас,
                            вашей потенциальной второй половинке? Образование?
                            Сфера деятельности? Должность? Качества? Увлечения?
                            Достижения? Район проживания г. Н. Новгорода?
                        </T>
                        <FormInputTextAria
            ...
            case 14:
                return (
                    <>
                        ...
                        <FormInputDate
                            control={control}
                            label="Дата окончания отношений"
                            name="dateofend"
                        />
                    </>
                );
            ...
            case 17:
                return (
                    <>
                        ...
                        <FormInputDate
                            control={control}
                            label="Выберите дату заполнения анкеты"
                            name="registermonth"
                        />
                        {/* date */}
                    </>
            ...
            case 21:
                return (
                    <>
                        <T>
                            Бывший муж (парень) или жена (девушка) в год кого
                            родились (если не знаете, то просто год рождения)?
                        </T>
                        <FormInputTextAria
                            control={control}
                            label=""
            ...
            case 22:
                return (
                    <>
                        <T>
                            Знак зодиака бывшего мужа или жены? (если не знаете,
                            то просто число и месяц даты рождения)
                        </T>
                        <FormInputTextAria
            ...
            case 24:
                return (
                    <>
                        <T>
                            В ближайшее время мы с вами свяжемся и подтвердим
                            информацию
                        </T>
            ...
            case 25:
                return (
                    <>
                        <T>
                            После рассмотрения вы можете войти в свой личный
                            кабинет
                        </T>
    ...
    return (
        ...
        >
            <Form onSubmit={handleSubmit(onSubmit)}>
                <T sx={{ color: purple[600], fontSize: "1.75rem" }}>
                    Заявка на счастливую личную жизнь
                </T>
                <T>
                ...
                <p>
                    <Button
                        ...
                        disabled={value === 0}
                        sx={{ marginRight: "5%", bgcolor: purple[600] }}
                    >
                        Назад
                    </Button>
                    {value > 6 ? (
                        <Button
                            ...
                            disabled={value === 25}
                            sx={{ marginLeft: "5%", bgcolor: purple[600] }}
                        >
                            Вперед
                        </Button>
                    ) : (
